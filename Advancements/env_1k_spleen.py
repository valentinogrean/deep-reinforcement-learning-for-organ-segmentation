...
def generate_slices_with_organ():
    ...
    with open("pickles\\patients_1k_organ3", "wb") as fp:   #Pickling
        pickle.dump(patients, fp)
    with open("pickles\\images_1k_organ3", "wb") as fp:   #Pickling
        pickle.dump(images, fp)
    with open("pickles\\segmentations_1k_organ3", "wb") as fp:   #Pickling
...
def get_full_segmentation(patient_number, slice_number):
    ...
    segmentation_slice[segmentation_slice == 3] = 1
...
class CTEnv1k:
    def __init__(self, render=False, final_render = False, random_slice=True, patient_number=0, slice_number=0):
        ...
        if random_slice == True:
            ...
            with open("pickles\\patients_1k_organ3", "rb") as fp:   # Unpickling
                self.patients = pickle.load(fp)
            with open("pickles\\images_1k_organ3", "rb") as fp:   # Unpickling
                self.images = pickle.load(fp)
            with open("pickles\\segmentations_1k_organ3", "rb") as fp:   # Unpickling
