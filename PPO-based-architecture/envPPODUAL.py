...
def generate_slices_with_organ():
    ...
    with open("patients", "wb") as fp:   #Pickling
        pickle.dump(patients, fp)
    with open("images", "wb") as fp:   #Pickling
        pickle.dump(images, fp)
    with open("segmentations", "wb") as fp:   #Pickling
...
class CTEnv:
    def __init__(self, render=False, final_render = False, random_slice=True, patient_number=0, slice_number=0):
        ...
        self.new_range_start = 140 - self.new_min_start
        self.new_min_end = 80
